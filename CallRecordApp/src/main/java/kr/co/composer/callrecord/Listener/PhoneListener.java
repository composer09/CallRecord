...
//	private Uri uri;
//
//	public PhoneListener(Context context, Intent intent) {
...
//			if(callInfoPreferenceManager.getCallState()) {
//				Log.i("OFFHOOK", "OFFHOOK상태");
////				
//				System.out.println("발신번호 확인 :"+intent.getStringExtra(Intent.EXTRA_PHONE_NUMBER));
//				System.out.println("수신번호 확인 :"+intent.getExtras().getString(TelephonyManager.EXTRA_INCOMING_NUMBER));
...
//				}else if(intent.getExtras().getString(TelephonyManager.EXTRA_INCOMING_NUMBER) != null){
