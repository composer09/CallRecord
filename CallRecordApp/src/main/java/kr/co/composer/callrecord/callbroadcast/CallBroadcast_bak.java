...
//
//public class CallBroadcast_bak extends BroadcastReceiver {
//
...
//								if(id != 0){
//									callInfoPreferenceManager.setContactId(id);
//								}else{callInfoPreferenceManager.setContactId(1);}
//								cursor.close();
//							} else {
//								callInfoPreferenceManager.setContactId(1);
...
//								callInfoPreferenceManager.getContactId(),
//								callInfoPreferenceManager.getStartDate()
